...
@Component({
  ...
  <div class="h-[100px] items-center justify-between w-full flex flex-col lg:flex-row section-padding bg-simple-header">
    <div class="hidden lg:inline-flex w-full items-center">
      <div class="flex w-1/2">
        <div class="w-1/2 flex justify-center">
          <div class="flex justify-center">
          <div>
              <!-- <img src="/assets/img/svg/logo.svg" alt="img"> -->
            </div>
      ...
      <div class="w-1/2">
        <div class="flex flex-row justify-between items-center header">
          <div>
            <a class="text-gray-200" href="/user/home">
              Home
            </a>
          </div>
          <div>
            <a class="text-gray-200" routerLink="about" routerLinkActive="active">
              About
            </a>
          </div>
          <div>
            <div class="dropdown py-5">
              <button class="dropbtn" routerLink="services">
                Services
              ...
              <div class="dropdown-content dropdown-shadow rounded-lg">
                ...
                <a routerLink="web-services" routerLinkActive="active" class="text-center text-sm dropdown-text">Web</a>
          ...
          <div>
            <a class="text-gray-200" routerLink="work" routerLinkActive="active">
              Work
            </a>
          </div>
          <div>
        ...
        <div class="pb-4 px-5 overflow-y-auto">
          <ul class="font-medium">
            <li class="flex justify-between items-center border-bottom navbar" data-drawer-hide="drawer-navigation">
              <a href="" class="flex items-center p-3 text-gray-200 rounded-lg dark:text-white group">
                <span class="ml-3">Home</span>
              </a>
            </li>
            <li class="flex justify-between items-center border-bottom navbar" data-drawer-hide="drawer-navigation">
              <a routerLink="about" routerLinkActive="active" class="flex items-center p-3 text-gray-200 rounded-lg dark:text-white group">
            ...
            <li class="flex justify-between items-center border-bottom navbar" data-drawer-hide="drawer-navigation">
              <a routerLink="work" routerLinkActive="active" class="flex items-center p-3 text-gray-200 rounded-lg dark:text-white group">
  ...
  <div class="flex flex-col py-5 bg-footer section-padding">
    ...
    <div class="flex flex-row justify-center px-5 lg:px-20">
      <small class="mt-5 footer-text text-lg text-white">Copyright © . All Rights
        Reserved.</small>
    </div>
  </div>
</div>
  ...
  styles: [
    `
     .bg-header,.bg-services-header,.bg-web-services{
          background-image: url('/assets/img/svg/home-banner.svg');
